...
const ProductModal = ({ p, products, onClose, onAdd, onPick }) => {
  ...
  const buyWA = () => {
    ...
    window.open(`${window.ERESS_CONTACT.whatsappUrl}?text=${encodeURIComponent(msg)}`, '_blank');
  };
...
const App = () => {
  ...
  return (
    <>
      ...
      <a className="wa-float" href={window.ERESS_CONTACT.whatsappUrl} target="_blank" rel="noopener" aria-label="WhatsApp">
