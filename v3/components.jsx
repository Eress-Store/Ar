...
// ╚══════════════════════════════════════════════════════════════╝
// ╔══════════════════════════════════════════════════════════════╗
// ║  EDITAR AQUÍ ▼  — Datos de contacto globales                  ║
// ║  Estos valores se usan en TODA la web (botones WhatsApp,      ║
// ║  Instagram, footer, modal de producto, etc.)                  ║
// ╚══════════════════════════════════════════════════════════════╝
window.ERESS_CONTACT = {
  // WhatsApp: solo dígitos, con código de país (54) + 9 + número sin 0 ni 15
  whatsappNumber: "5493704344885",
  whatsappDisplay: "+54 9 3704 344885",
  whatsappUrl: "https://wa.me/5493704344885",

  // Instagram
  instagramUser: "eress_store",
  instagramUrl: "https://instagram.com/eress_store",
};
// ╔══════════════════════════════════════════════════════════════╗
// ║  EDITAR AQUÍ ▲                                                ║
// ╚══════════════════════════════════════════════════════════════╝
...
const FOOTER_CONFIG = {
  ...
  instagram: window.ERESS_CONTACT.instagramUrl,
  whatsapp: window.ERESS_CONTACT.whatsappUrl,
  ...
  contacto: [
    { label: `WhatsApp · ${window.ERESS_CONTACT.whatsappDisplay}`, href: window.ERESS_CONTACT.whatsappUrl },
...
const CartDrawer = ({ cart, onClose, updateQty, removeItem, products }) => {
  ...
  const checkoutWA = () => {
    ...
    window.open(`${window.ERESS_CONTACT.whatsappUrl}?text=${msg}`, '_blank');
  };
