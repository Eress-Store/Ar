  ...
  return (
    <main>
      ...
      <section className="container">
        <div className="story">
          <div className="story-visual bg-rich">
            <div className="story-visual-svg">
              <svg width="60%" height="60%" viewBox="0 0 200 280" fill="none">
                <path d="M100 20 C 60 20, 40 60, 40 120 L 40 240 C 40 260, 60 270, 100 270 C 140 270, 160 260, 160 240 L 160 120 C 160 60, 140 20, 100 20 Z"
                      stroke="#d4af37" strokeWidth="1" fill="rgba(212, 175, 55, 0.04)"/>
                <path d="M70 80 L 130 80 L 130 60 L 70 60 Z" stroke="#d4af37" strokeWidth="1" fill="rgba(212, 175, 55, 0.1)"/>
                <circle cx="100" cy="160" r="30" stroke="#d4af37" strokeWidth="0.5" fill="none"/>
                <circle cx="100" cy="160" r="20" stroke="#d4af37" strokeWidth="0.5" fill="none"/>
                <text x="100" y="165" textAnchor="middle" fill="#d4af37" fontFamily="Bodoni Moda" fontSize="14" letterSpacing="3">ERESS</text>
              </svg>
            </div>
          </div>
          <div>
